...
DOC_EMB_DIR=$ROOT"cocodenser/representations_retriever/collection_augsep_embeddings_memmap/" # "TAS-B/representations/doc_embeddings_memmap/"
QUERY_EMB_DIR=$ROOT"coder/representations/label_smoothing/" #"cocodenser/representations_retriever/"  #"coder/representations/$MODEL_ALIAS/"  #"coder/representations/label_smoothing/"$MODEL_ALIAS/
